        ...
        <div className="container">
            ...
            <ul className={s.servicesList}>
                <li className={s.servicesList_item}>
                    ...
                    <p className={s.servicesList_description}>With a robust proficiency in
                ...
                <li className={s.servicesList_item}>
                    ...
                    <p className={s.servicesList_description}>Skilled in Node.js, Express.js, Java I build scalable backend systems and efficient server-side solutions using databases like MongoDB and MySQL for dynamic applications.</p>
                </li>
                <li className={s.servicesList_item}>
                    ...
                    <p className={s.servicesList_description}>With strong expertise in UI/UX design, I excel at creating intuitive and visually engaging user experiences, translating user needs into seamless, impactful Designs.</p>
                </li>
                <li className={s.servicesList_item}>
                    <img className={s.servicesList_img} src="public/images/service4-min.jpg" alt="app" />
                    <h4 className={s.servicesList_title}>Flutter App Development</h4>
                    <p className={s.servicesList_description}>Proficient in Flutter and Firebase, I build cross-platform, high-performance mobile apps with real-time data and seamless backend integration.</p>
                </li>
            </ul>
        </div>
    )
